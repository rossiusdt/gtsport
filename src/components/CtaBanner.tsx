  ...
  return (
    <section className="py-24 bg-green-600 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 text-center">
        ...
        <a
          href="#planos"
          className="inline-flex items-center gap-2 px-10 py-5 bg-white text-green-700 font-black text-base rounded-xl hover:bg-green-50 transition-all duration-200 hover:scale-105 hover:shadow-2xl"
        >
          Ver planos agora
