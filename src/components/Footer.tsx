      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-3 mt-5">
              <a
                href="#"
                className="w-9 h-9 bg-zinc-800 hover:bg-yellow-400 rounded-lg flex items-center justify-center transition-colors duration-200 group"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Orange Anual', 'Platinum Mensal', 'Plano Mensal', 'Plano Trimestral'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-zinc-400 hover:text-yellow-400 text-sm transition-colors">
                    {item}
                  </a>
                </li>
              ))}
        ...
        <div className="border-t border-zinc-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-zinc-600 text-xs">
            © 2024 LoudFit Ipiranga. Todos os direitos reservados.
          </p>
