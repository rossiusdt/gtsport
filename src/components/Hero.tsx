    ...
    <section className="relative min-h-screen flex items-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-16">
        <div className="max-w-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-teal-400/20 border border-teal-400/30 rounded-full mb-6">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white leading-none mb-6">
            TRANSFORME
            <br />
            <span className="text-teal-400">SEU CORPO.</span>
            <br />
            SUA VIDA.
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <a
              href="#planos"
              className="inline-flex items-center justify-center px-8 py-4 bg-teal-400 hover:bg-teal-300 text-black font-black text-base rounded-xl transition-all duration-200 hover:scale-105 hover:shadow-lg hover:shadow-teal-400/30"
            >
              Ver planos e preços
            </a>
            <a
              href="#modalidades"
              className="inline-flex items-center justify-center px-8 py-4 border border-white/20 hover:border-teal-400/40 text-white font-semibold text-base rounded-xl transition-all duration-200 backdrop-blur-sm hover:text-teal-400"
            >
      ...
      <a
        href="#planos"
        className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-zinc-400 hover:text-teal-400 transition-colors group"
      >
        <span className="text-xs font-medium tracking-widest uppercase">Ver planos</span>
        <ArrowDown className="w-4 h-4 animate-bounce group-hover:text-teal-400" />
      </a>
    </section>
  );
}
