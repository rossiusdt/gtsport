        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white leading-tight mb-6">
              Muito mais do que
              <br />
              <span className="text-teal-400">uma academia</span>
            </h2>
          ...
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-6 -left-6 bg-teal-400 rounded-2xl p-5 shadow-xl">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature) => {
            ...
            return (
              <div
                key={feature.title}
                className="group p-7 rounded-2xl border border-zinc-800 hover:border-teal-400/30 hover:shadow-lg hover:shadow-teal-400/5 transition-all duration-300 bg-zinc-900"
              >
                <div className="w-12 h-12 bg-teal-400/10 group-hover:bg-teal-400 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300">
                  <Icon className="w-5 h-5 text-teal-400 group-hover:text-black transition-colors duration-300" />
                </div>
